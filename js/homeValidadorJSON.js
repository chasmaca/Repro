...
//							if (array[x].gastosImpresoras != null)
//								totalImpresorasByN = array[x].gastosImpresoras;
							
//							if (array[x].impresorasColor != null)
//								totalImpresorasColor = array[x].impresorasColor;
//							
//							if (array[x].maquinasByN != null)
//								totalMaquinasByN = array[x].maquinasByN;
//							
//							if (array[x].maquinasColor != null)
//								totalMaquinasColor = array[x].maquinasColor;
