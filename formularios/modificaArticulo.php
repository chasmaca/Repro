...
?>
		...
		<div id='cssformulario' class='cssformulario'>
			...
			<form name="modificaArticuloForm" id="modificaArticuloForm" method="post" action="../dao/update/modificarArticulo.php">
				<h2>Modificar Articulo</h2>
				<div class="inset">
				<label for="tipoId">Tipo</label>
				<select name="tipoId" id="tipoId" onchange="javascript:actualizaDetalle();">
...
?>
				...
				<div id="submitM"  style="visibility:hidden;">
					<input type="button" name="modificaArticuloSubmit" id="modificaArticuloSubmit" value="Modifica Articulo"  onclick="javascript:validaFormulario();">
				</div>
				</div>
			</form>
