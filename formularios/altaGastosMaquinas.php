...
$pathMaquina = "../dao/select/gastoMaquina.php";
?>
...
<head>
	...
	<script src="../js/altaGastosMaquina.js" type="text/javascript" ></script>
...
?>
        <div id='cssformulario' class='cssformulario'>
        	<form id="gastosImpresora" name="gastosImpresora" action="">
        	 <h1>Gastos de M&aacute;quinas</h1>
