...
<div id='cssformulario' class='cssformulario'>
	<form name="borraCarrera" id="borraCarrera" method="post" action="../dao/insert/borrarCarrera.php">
...
?>
			...
			<input type="hidden" id="nombreCarrera" name="nombreCarrera"/> 
			<input type="hidden" id="idCarrera" name="idCarrera"/>
			
			<input type="submit" name="borraCarrera" id="borraCarrera" value="Borrar Carrera"/>
